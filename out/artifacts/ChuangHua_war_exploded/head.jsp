...
<!--顶部-->
<div class="top">
    <div class="usebar"><a href="${pageContext.request.contextPath}/goHomePage" id="ubl"><img src="statics/icon/用户.png" alt="" class="usericon"></a></div>
    <div class="logo">
        <a href="${pageContext.request.contextPath}/allTopic"><img src="statics/icon/logo.png"  width="50px" height="50px"></a>
    </div>
